<template>
  <div v-if="projectSelected">
    <div class="DownloadButton">
      <button class="button is-info" @click="printPDF(projectSelected.thaiProjectName)">
    ...
    <div style="display: flex; justify-content: center;">
      <div class="box bg-cl-white pd-40px mg-t-25px">
        <div id="frontBook" class="LayoutFrame">
          ...
          <div class="media logoKMUTNB mg-t-50px">
            <figure>
          ...
          <div class= "topTitle" >
            <center class="mg-bt-5px"><h2><b class="font" style="font-size: 25px;">แบบรายงานความก้าวหน้าของโครงงานพิเศษ (ปริญญานิพนธ์)</b></h2></center>
            <center class="mg-bt-5px"><h2><b class="font" style="font-size: 25px;">สาขาวิชาเทคโนโลยีสารสนเทศ ภาควิชาเทคโนโลยีสารสนเทศ</b></h2></center>
