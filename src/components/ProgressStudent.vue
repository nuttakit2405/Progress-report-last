<template>
  <div v-if="profile && profile.userType == 'student'">
    ...
    <div class="has-text-centered">
      <button class="button is-info"  style="font-family: 'Kanit', sans-serif" @click="saveConfirm" :disabled="(+progressTotal >= +progress || +progress > 100) || weekData.sentTeacher"> ยืนยัน<span v-if="yourConfirm">แล้ว</span> </button>
