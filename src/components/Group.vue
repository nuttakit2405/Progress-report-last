      ...
      <div class="card">
        ...
        <div class="card-content">
          <div class="columns" style="align-items: center">
            <div class="column is-paddingless"><progress class="progress" :class="[ data.progress == 100 ? 'is-success' : 'is-info']" :value="data.progress ? data.progress : 0" max="100"></progress></div>
